                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    ?>
                                        <tr class="odd gradeX">
                                            ...
                                            onclick="return confirm('Aktiflik Durumunu Değiştirmek İstediğinize Emin Misiniz? ')"
                                            ...
                                            <a href="blog.php?is=sil&id=<?= $row["id"] ?>" onclick="return confirm('Silmek İstediğinize Emin Misiniz?')"class="btn btn-danger btn-xs" style="margin-right:15px;">Sil</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                    </tbody>
