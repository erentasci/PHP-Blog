...
if(@$_POST["submit"]){
    ...
    $guncelle= $db->prepare("UPDATE `blog` SET `baslik` = :baslik, `alt_baslik` = :alt_baslik , `aciklama` = :aciklama , `aktif` = :aktif WHERE `id` = :id");
    ...
    if($guncelle->execute()){
        header("Location: blog.php?i=duzenle");
    }else{
                                ...
                                <div class="col-lg-6">
                                    <form role="form" action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label>Başlık</label>
                                            <input class="form-control" value="<?= $row["baslik"] ?>" name="baslik" placeholder="Başlık giriniz...">
                                        </div>
                                        <div class="form-group">
                                            <label>Altbaşlık</label>
                                            <input class="form-control" name="alt_baslik" value="<?= $row["alt_baslik"] ?>" placeholder="Altbaşlık giriniz...">
                                        </div>
